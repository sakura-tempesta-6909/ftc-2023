...
//            telemetry.addData("dronelauncher",state.dronelauncherPosition)
            ...
            telemetry.addData("rightSliderTarget", state.rightSliderTargetPosition)
            telemetry.addData("leftSliderTarget", state.leftSliderTargetPosition)
            telemetry.addData("rightSliderCurrent", state.rightSliderCurrentPosition)
            telemetry.addData("leftSliderCurrent", state.leftSliderCurrentPosition)
